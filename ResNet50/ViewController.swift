...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var resnetObject: UILabel!
    @IBOutlet weak var resnetConfidence: UILabel!
    ...
    func myResultsMethod(request: VNRequest, error: Error?) {
        ...
        self.resnetObject.text = "Object: " + (maxClassification?.identifier)!
        
        self.resnetConfidence.text = "Confidence: " + String(describing: (maxClassification?.confidence)!)
    }
